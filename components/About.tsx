        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="prose prose-slate text-slate-600 leading-relaxed text-justify">
              <p className="mb-4">
                ما در <strong>Buy3</strong> با درک عمیق از چالش‌های کاربران ایرانی برای دسترسی به بازارهای جهانی، پلتفرمی را طراحی کرده‌ایم که فرآیند پیچیده واردات را به یک تجربه خرید آنلاین ساده تبدیل می‌کند.
              </p>
              <p className="mb-4">

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-slate-600 leading-8 mb-8 text-justify">
              چین کارخانه دنیاست و ما کلید ورود شما به این کارخانه هستیم. تیم Buy3 با داشتن دفاتر همکار در چین، تمام زنجیره تامین از پیدا کردن سورس اصلی تا تحویل بار در ایران را مدیریت می‌کند. دیگر نگران اعتبار فروشنده چینی یا پیچیدگی‌های گمرکی نباشید.
            </p>
